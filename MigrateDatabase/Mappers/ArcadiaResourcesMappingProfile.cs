...
public class ArcadiaResourcesMappingProfile : Profile
{
	public ArcadiaResourcesMappingProfile()
	{
		...
		CreateMap<MSSQLNPCResource, NpcResourceEntity>()
				.ForMember(dst => dst.Id, ex => ex.MapFrom(src => src.id))
				.ForMember(dst => dst.TextId, ex => ex.MapFrom(src => src.text_id))
				.ForMember(dst => dst.NameId, ex => ex.MapFrom(src => src.name_text_id))
				.ForMember(dst => dst.RaceId, ex => ex.MapFrom(src => src.race_id))
				.ForMember(dst => dst.SexualId, ex => ex.MapFrom(src => src.sexsual_id))
				.ForMember(dst => dst.X, ex => ex.MapFrom(src => src.x))
				.ForMember(dst => dst.Y, ex => ex.MapFrom(src => src.y))
				.ForMember(dst => dst.Z, ex => ex.MapFrom(src => src.z))
				.ForMember(dst => dst.Face, ex => ex.MapFrom(src => src.face))
				.ForMember(dst => dst.LocalFlag, ex => ex.MapFrom(src => src.local_flag))
				.ForMember(dst => dst.IsPeriodic, ex => ex.MapFrom(src => src.is_periodic))
				.ForMember(dst => dst.BeginOfPeriod, ex => ex.MapFrom(src => src.begin_of_period))
				.ForMember(dst => dst.EndOfPeriod, ex => ex.MapFrom(src => src.end_of_period))
				.ForMember(dst => dst.FaceX, ex => ex.MapFrom(src => src.face_x))
				.ForMember(dst => dst.FaceY, ex => ex.MapFrom(src => src.face_y))
				.ForMember(dst => dst.FaceZ, ex => ex.MapFrom(src => src.face_z))
				.ForMember(dst => dst.ModelFile, ex => ex.MapFrom(src => src.model_file))
				.ForMember(dst => dst.HairId, ex => ex.MapFrom(src => src.hair_id))
				.ForMember(dst => dst.FaceId, ex => ex.MapFrom(src => src.face_id))
				.ForMember(dst => dst.BodyId, ex => ex.MapFrom(src => src.body_id))
				.ForMember(dst => dst.WeaponItemId, ex => ex.MapFrom(src => src.weapon_item_id))
				.ForMember(dst => dst.ShieldItemId, ex => ex.MapFrom(src => src.shield_item_id))
				.ForMember(dst => dst.ClothesItemId, ex => ex.MapFrom(src => src.clothes_item_id))
				.ForMember(dst => dst.HelmItemId, ex => ex.MapFrom(src => src.helm_item_id))
				.ForMember(dst => dst.GlovesItemId, ex => ex.MapFrom(src => src.gloves_item_id))
				.ForMember(dst => dst.BootsItemId, ex => ex.MapFrom(src => src.boots_item_id))
				.ForMember(dst => dst.BeltItemId, ex => ex.MapFrom(src => src.belt_item_id))
				.ForMember(dst => dst.MantleItemId, ex => ex.MapFrom(src => src.mantle_item_id))
				.ForMember(dst => dst.NecklaceItemId, ex => ex.MapFrom(src => src.necklace_item_id))
				.ForMember(dst => dst.EarringItemId, ex => ex.MapFrom(src => src.earring_item_id))
				.ForMember(dst => dst.Ring1ItemId, ex => ex.MapFrom(src => src.ring1_item_id))
				.ForMember(dst => dst.Ring2ItemId, ex => ex.MapFrom(src => src.ring2_item_id))
				.ForMember(dst => dst.MotionId, ex => ex.MapFrom(src => src.motion_id))
				.ForMember(dst => dst.IsRoam, ex => ex.MapFrom(src => src.is_roam))
				.ForMember(dst => dst.RoamingId, ex => ex.MapFrom(src => src.roaming_id))
				.ForMember(dst => dst.StandardWalkSpeed, ex => ex.MapFrom(src => src.standard_walk_speed))
				.ForMember(dst => dst.StandardRunSpeed, ex => ex.MapFrom(src => src.standard_run_speed))
				.ForMember(dst => dst.WalkSpeed, ex => ex.MapFrom(src => src.walk_speed))
				.ForMember(dst => dst.RunSpeed, ex => ex.MapFrom(src => src.run_speed))
				.ForMember(dst => dst.Attackable, ex => ex.MapFrom(src => src.attackable))
				.ForMember(dst => dst.OffensiveType, ex => ex.MapFrom(src => src.offensive_type))
				.ForMember(dst => dst.SpawnType, ex => ex.MapFrom(src => src.spawn_type))
				.ForMember(dst => dst.ChaseRange, ex => ex.MapFrom(src => src.chase_range))
				.ForMember(dst => dst.RegenTime, ex => ex.MapFrom(src => src.regen_time))
				.ForMember(dst => dst.Level, ex => ex.MapFrom(src => src.level))
				.ForMember(dst => dst.StatId, ex => ex.MapFrom(src => src.stat_id))
				.ForMember(dst => dst.AttackRange, ex => ex.MapFrom(src => src.attack_range))
				.ForMember(dst => dst.AttackSpeedType, ex => ex.MapFrom(src => src.attack_speed_type))
				.ForMember(dst => dst.Hp, ex => ex.MapFrom(src => src.hp))
				.ForMember(dst => dst.Mp, ex => ex.MapFrom(src => src.mp))
				.ForMember(dst => dst.AttackPoint, ex => ex.MapFrom(src => src.attack_point))
				.ForMember(dst => dst.MagicPoint, ex => ex.MapFrom(src => src.magic_point))
				.ForMember(dst => dst.Defence, ex => ex.MapFrom(src => src.defence))
				.ForMember(dst => dst.MagicDefence, ex => ex.MapFrom(src => src.magic_defence))
				.ForMember(dst => dst.AttackSpeed, ex => ex.MapFrom(src => src.attack_speed))
				.ForMember(dst => dst.MagicSpeed, ex => ex.MapFrom(src => src.magic_speed))
				.ForMember(dst => dst.Accuracy, ex => ex.MapFrom(src => src.accuracy))
				.ForMember(dst => dst.Avoid, ex => ex.MapFrom(src => src.avoid))
				.ForMember(dst => dst.MagicAccuracy, ex => ex.MapFrom(src => src.magic_accuracy))
				.ForMember(dst => dst.MagicAvoid, ex => ex.MapFrom(src => src.magic_avoid))
				.ForMember(dst => dst.AiScript, ex => ex.MapFrom(src => src.ai_script))
				.ForMember(dst => dst.ContactScript, ex => ex.MapFrom(src => src.contact_script))
				.ForMember(dst => dst.TextureGroup, ex => ex.MapFrom(src => src.texture_group))
				.ForMember(dst => dst.Type, ex => ex.MapFrom(src => src.type))
				.ReverseMap();
		...
		CreateMap<MSSQLMixResource, MixResourceEntity>()
			.ForMember(src => src.Id, ex => ex.MapFrom(dst => dst.id))
			.ForMember(src => src.MixType, ex => ex.MapFrom(dst => dst.mix_type))
			.ForMember(src => src.MixValue01, ex => ex.MapFrom(dst => dst.mix_value_01))
			.ForMember(src => src.MixValue02, ex => ex.MapFrom(dst => dst.mix_value_02))
			.ForMember(src => src.MixValue03, ex => ex.MapFrom(dst => dst.mix_value_03))
			.ForMember(src => src.MixValue04, ex => ex.MapFrom(dst => dst.mix_value_04))
			.ForMember(src => src.MixValue05, ex => ex.MapFrom(dst => dst.mix_value_05))
			.ForMember(src => src.MixValue06, ex => ex.MapFrom(dst => dst.mix_value_06))
			.ForMember(src => src.SubMaterialCount, ex => ex.MapFrom(dst => dst.sub_material_count))
			.ForMember(src => src.MainType01, ex => ex.MapFrom(dst => dst.main_type_01))
			.ForMember(src => src.MainValue01, ex => ex.MapFrom(dst => dst.main_value_01))
			.ForMember(src => src.MainType02, ex => ex.MapFrom(dst => dst.main_type_02))
			.ForMember(src => src.MainValue02, ex => ex.MapFrom(dst => dst.main_value_02))
			.ForMember(src => src.MainType03, ex => ex.MapFrom(dst => dst.main_type_03))
			.ForMember(src => src.MainValue03, ex => ex.MapFrom(dst => dst.main_value_03))
			.ForMember(src => src.MainType04, ex => ex.MapFrom(dst => dst.main_type_04))
			.ForMember(src => src.MainValue04, ex => ex.MapFrom(dst => dst.main_value_04))
			.ForMember(src => src.MainType05, ex => ex.MapFrom(dst => dst.main_type_05))
			.ForMember(src => src.MainValue05, ex => ex.MapFrom(dst => dst.main_value_05))
			.ForMember(src => src.Sub01Type01, ex => ex.MapFrom(dst => dst.sub01_type_01))
			.ForMember(src => src.Sub01Value01, ex => ex.MapFrom(dst => dst.sub01_value_01))
			.ForMember(src => src.Sub01Type02, ex => ex.MapFrom(dst => dst.sub01_type_02))
			.ForMember(src => src.Sub01Value02, ex => ex.MapFrom(dst => dst.sub01_value_02))
			.ForMember(src => src.Sub01Type03, ex => ex.MapFrom(dst => dst.sub01_type_03))
			.ForMember(src => src.Sub01Value03, ex => ex.MapFrom(dst => dst.sub01_value_03))
			.ForMember(src => src.Sub01Type04, ex => ex.MapFrom(dst => dst.sub01_type_04))
			.ForMember(src => src.Sub01Value04, ex => ex.MapFrom(dst => dst.sub01_value_04))
			.ForMember(src => src.Sub01Type05, ex => ex.MapFrom(dst => dst.sub01_type_05))
			.ForMember(src => src.Sub01Value05, ex => ex.MapFrom(dst => dst.sub01_value_05))
			.ForMember(src => src.Sub02Type01, ex => ex.MapFrom(dst => dst.sub02_type_01))
			.ForMember(src => src.Sub02Value01, ex => ex.MapFrom(dst => dst.sub02_value_01))
			.ForMember(src => src.Sub02Type02, ex => ex.MapFrom(dst => dst.sub02_type_02))
			.ForMember(src => src.Sub02Value02, ex => ex.MapFrom(dst => dst.sub02_value_02))
			.ForMember(src => src.Sub02Type03, ex => ex.MapFrom(dst => dst.sub02_type_03))
			.ForMember(src => src.Sub02Value03, ex => ex.MapFrom(dst => dst.sub02_value_03))
			.ForMember(src => src.Sub02Type04, ex => ex.MapFrom(dst => dst.sub02_type_04))
			.ForMember(src => src.Sub02Value04, ex => ex.MapFrom(dst => dst.sub02_value_04))
			.ForMember(src => src.Sub02Type05, ex => ex.MapFrom(dst => dst.sub02_type_05))
			.ForMember(src => src.Sub02Value05, ex => ex.MapFrom(dst => dst.sub02_value_05))
			.ForMember(src => src.Sub03Type01, ex => ex.MapFrom(dst => dst.sub03_type_01))
			.ForMember(src => src.Sub03Value01, ex => ex.MapFrom(dst => dst.sub03_value_01))
			.ForMember(src => src.Sub03Type02, ex => ex.MapFrom(dst => dst.sub03_type_02))
			.ForMember(src => src.Sub03Value02, ex => ex.MapFrom(dst => dst.sub03_value_02))
			.ForMember(src => src.Sub03Type03, ex => ex.MapFrom(dst => dst.sub03_type_03))
			.ForMember(src => src.Sub03Value03, ex => ex.MapFrom(dst => dst.sub03_value_03))
			.ForMember(src => src.Sub03Type04, ex => ex.MapFrom(dst => dst.sub03_type_04))
			.ForMember(src => src.Sub03Value04, ex => ex.MapFrom(dst => dst.sub03_value_04))
			.ForMember(src => src.Sub03Type05, ex => ex.MapFrom(dst => dst.sub03_type_05))
			.ForMember(src => src.Sub03Value05, ex => ex.MapFrom(dst => dst.sub03_value_05))
			.ForMember(src => src.Sub04Type01, ex => ex.MapFrom(dst => dst.sub04_type_01))
			.ForMember(src => src.Sub04Value01, ex => ex.MapFrom(dst => dst.sub04_value_01))
			.ForMember(src => src.Sub04Type02, ex => ex.MapFrom(dst => dst.sub04_type_02))
			.ForMember(src => src.Sub04Value02, ex => ex.MapFrom(dst => dst.sub04_value_02))
			.ForMember(src => src.Sub04Type03, ex => ex.MapFrom(dst => dst.sub04_type_03))
			.ForMember(src => src.Sub04Value03, ex => ex.MapFrom(dst => dst.sub04_value_03))
			.ForMember(src => src.Sub04Type04, ex => ex.MapFrom(dst => dst.sub04_type_04))
			.ForMember(src => src.Sub04Value04, ex => ex.MapFrom(dst => dst.sub04_value_04))
			.ForMember(src => src.Sub04Type05, ex => ex.MapFrom(dst => dst.sub04_type_05))
			.ForMember(src => src.Sub04Value05, ex => ex.MapFrom(dst => dst.sub04_value_05))
			.ForMember(src => src.Sub05Type01, ex => ex.MapFrom(dst => dst.sub05_type_01))
			.ForMember(src => src.Sub05Value01, ex => ex.MapFrom(dst => dst.sub05_value_01))
			.ForMember(src => src.Sub05Type02, ex => ex.MapFrom(dst => dst.sub05_type_02))
			.ForMember(src => src.Sub05Value02, ex => ex.MapFrom(dst => dst.sub05_value_02))
			.ForMember(src => src.Sub05Type03, ex => ex.MapFrom(dst => dst.sub05_type_03))
			.ForMember(src => src.Sub05Value03, ex => ex.MapFrom(dst => dst.sub05_value_03))
			.ForMember(src => src.Sub05Type04, ex => ex.MapFrom(dst => dst.sub05_type_04))
			.ForMember(src => src.Sub05Value04, ex => ex.MapFrom(dst => dst.sub05_value_04))
			.ForMember(src => src.Sub05Type05, ex => ex.MapFrom(dst => dst.sub05_type_05))
			.ForMember(src => src.Sub05Value05, ex => ex.MapFrom(dst => dst.sub05_value_05))
			.ForMember(src => src.Sub06Type01, ex => ex.MapFrom(dst => dst.sub06_type_01))
			.ForMember(src => src.Sub06Value01, ex => ex.MapFrom(dst => dst.sub06_value_01))
			.ForMember(src => src.Sub06Type02, ex => ex.MapFrom(dst => dst.sub06_type_02))
			.ForMember(src => src.Sub06Value02, ex => ex.MapFrom(dst => dst.sub06_value_02))
			.ForMember(src => src.Sub06Type03, ex => ex.MapFrom(dst => dst.sub06_type_03))
			.ForMember(src => src.Sub06Value03, ex => ex.MapFrom(dst => dst.sub06_value_03))
			.ForMember(src => src.Sub06Type04, ex => ex.MapFrom(dst => dst.sub06_type_04))
			.ForMember(src => src.Sub06Value04, ex => ex.MapFrom(dst => dst.sub06_value_04))
			.ForMember(src => src.Sub06Type05, ex => ex.MapFrom(dst => dst.sub06_type_05))
			.ForMember(src => src.Sub06Value05, ex => ex.MapFrom(dst => dst.sub06_value_05))
			.ForMember(src => src.Sub07Type01, ex => ex.MapFrom(dst => dst.sub07_type_01))
			.ForMember(src => src.Sub07Value01, ex => ex.MapFrom(dst => dst.sub07_value_01))
			.ForMember(src => src.Sub07Type02, ex => ex.MapFrom(dst => dst.sub07_type_02))
			.ForMember(src => src.Sub07Value02, ex => ex.MapFrom(dst => dst.sub07_value_02))
			.ForMember(src => src.Sub07Type03, ex => ex.MapFrom(dst => dst.sub07_type_03))
			.ForMember(src => src.Sub07Value03, ex => ex.MapFrom(dst => dst.sub07_value_03))
			.ForMember(src => src.Sub07Type04, ex => ex.MapFrom(dst => dst.sub07_type_04))
			.ForMember(src => src.Sub07Value04, ex => ex.MapFrom(dst => dst.sub07_value_04))
			.ForMember(src => src.Sub07Type05, ex => ex.MapFrom(dst => dst.sub07_type_05))
			.ForMember(src => src.Sub07Value05, ex => ex.MapFrom(dst => dst.sub07_value_05))
			.ForMember(src => src.Sub08Type01, ex => ex.MapFrom(dst => dst.sub08_type_01))
			.ForMember(src => src.Sub08Value01, ex => ex.MapFrom(dst => dst.sub08_value_01))
			.ForMember(src => src.Sub08Type02, ex => ex.MapFrom(dst => dst.sub08_type_02))
			.ForMember(src => src.Sub08Value02, ex => ex.MapFrom(dst => dst.sub08_value_02))
			.ForMember(src => src.Sub08Type03, ex => ex.MapFrom(dst => dst.sub08_type_03))
			.ForMember(src => src.Sub08Value03, ex => ex.MapFrom(dst => dst.sub08_value_03))
			.ForMember(src => src.Sub08Type04, ex => ex.MapFrom(dst => dst.sub08_type_04))
			.ForMember(src => src.Sub08Value04, ex => ex.MapFrom(dst => dst.sub08_value_04))
			.ForMember(src => src.Sub08Type05, ex => ex.MapFrom(dst => dst.sub08_type_05))
			.ForMember(src => src.Sub08Value05, ex => ex.MapFrom(dst => dst.sub08_value_05))
			.ForMember(src => src.Sub09Type01, ex => ex.MapFrom(dst => dst.sub09_type_01))
			.ForMember(src => src.Sub09Value01, ex => ex.MapFrom(dst => dst.sub09_value_01))
			.ForMember(src => src.Sub09Type02, ex => ex.MapFrom(dst => dst.sub09_type_02))
			.ForMember(src => src.Sub09Value02, ex => ex.MapFrom(dst => dst.sub09_value_02))
			.ForMember(src => src.Sub09Type03, ex => ex.MapFrom(dst => dst.sub09_type_03))
			.ForMember(src => src.Sub09Value03, ex => ex.MapFrom(dst => dst.sub09_value_03))
			.ForMember(src => src.Sub09Type04, ex => ex.MapFrom(dst => dst.sub09_type_04))
			.ForMember(src => src.Sub09Value04, ex => ex.MapFrom(dst => dst.sub09_value_04))
			.ForMember(src => src.Sub09Type05, ex => ex.MapFrom(dst => dst.sub09_type_05))
			.ForMember(src => src.Sub09Value05, ex => ex.MapFrom(dst => dst.sub09_value_05))
			.ReverseMap();
